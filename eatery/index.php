        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarsExample05">
            <ul class="navbar-nav ml-auto pl-lg-5 pl-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="query.php">Other Query</a>
              </li>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="sched d-block d-lg-flex">
              <div class="bg-image order-2" style="background-image: url('img/arnold.jpg');"></div>
              <div class="text order-1">
                <h3>Arnold Poernomo</h3>
                <?php
                require_once("endpoint/endar.php"); ?>
              </div>
              
            </div>

            <div class="sched d-block d-lg-flex">
              <div class="bg-image" style="background-image: url('img/farah.jpg');"></div>
              <div class="text">
                <h3>Farah Queen</h3>
                <?php
                require_once("endpoint/endfar.php"); ?>
          ...
          <div class="col-md-6">
            <div class="sched d-block d-lg-flex">
              <div class="bg-image order-2" style="background-image: url('img/degan.jpg');"></div>
              <div class="text order-1">
                <h3>Degan Septoadji</h3>
                <?php
                require_once("endpoint/enddeg.php"); ?>
            ...
            <div class="sched d-block d-lg-flex">
              <div class="bg-image" style="background-image: url('img/juna.jpg');"></div>
              <div class="text">
                <h3>Juna Rorimpandey</h3>
                <?php
                require_once("endpoint/endjuna.php"); ?>
